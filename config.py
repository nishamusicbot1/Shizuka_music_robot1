...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/nishamusicbot1/Shizuka_music_robot1",
)
...
API_KEY = getenv("API_KEY", '30DxNexGenBotsfaa108') # youtube song api key, generate free key or buy paid plan from panel.thequickearn.xyz
